...
class Communication():
    ...
    def Print_Name(self):
        ...
        print("timeout(s):",self.main_engine.timeout)#读超时设置
...
Engine1 = Communication(serial_port,115200,0.4)
if (Ret):
    #Engine1.Recive_data(0)
    Engine1.Print_Name()
    Engine1.Send_data(bytes("CHAN;1300\n").encode("utf-8"))
    Engine1.Send_data(bytes("READ\n").encode("utf-8"))
    Engine1.Recive_data(0)
